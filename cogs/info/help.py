...
from utilities.pagination import MenuPages
...
class CogPageSource(menus.ListPageSource):
    def __init__(self, cog: Union[commands.Group, commands.Cog], command: List[commands.Command], *, prefix: str):
        ...
        self.description = self.cog.description

    async def format_page(self, menu: MenuPages, entries):
        embed = discord.Embed(title=self.title.title(),
                              description=self.description or 'No description given for now...',
